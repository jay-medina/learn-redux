...
describe("DivideOperator", () => {
  ...
  describe("when state is the init state", () => {
    describe("when user inputs a divide operator", () => {
  ...
  describe("when user has already input a divide operator", () => {
    describe("when user inputs a divide operator again", () => {
    ...
    describe("when user inputs a number value", () => {
      it('should divide the value to snd_value and update the screen', () => {
        const state = getInit();
  ...
  describe("when user inputs a divide operator", () => {
    describe("when 2nd value and memory are populated", () => {
      it('should set the value into memory, reset the 2nd value and update screen', () => {
        const state = getInit();

        let result = reducer(state, {type: 'UPDATE_VALUE', value: '6'});
            result = reducer(result, {type: 'UPDATE_VALUE', value: '/'});
            result = reducer(result, {type: 'UPDATE_VALUE', value: '3'});
            result = reducer(result, {type: 'UPDATE_VALUE', value: '/'});
  ...
  describe('when user inputs a divide operator', () => {
    describe('when 2nd value is zero', () => {
      it('should set the value on the screen to be not a number', () => {
        const state = getInit();
        
        let result = reducer(state, {type: 'UPDATE_VALUE', value: '6'});
            result = reducer(result, {type: 'UPDATE_VALUE', value: '/'});
            result = reducer(result, {type: 'UPDATE_VALUE', value: '0'});
            result = reducer(result, {type: 'UPDATE_VALUE', value: '='});
