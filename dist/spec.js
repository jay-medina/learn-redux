...
/***/ function(module, exports, __webpack_require__) {
	...
	var _numberReducer = __webpack_require__(170);

	var _numberReducer2 = _interopRequireDefault(_numberReducer);

	var _operatorReducer = __webpack_require__(172);

	var _operatorReducer2 = _interopRequireDefault(_operatorReducer);
	...
	var reducer = exports.reducer = function reducer(state, action) {
	  if (_underscore2.default.isUndefined(state)) {
	    return getInitState();
	  }

	  if (action.type === Types.UPDATE_VALUE) {
	    var nState = (0, _numberReducer2.default)(state, action);

	    return (0, _operatorReducer2.default)(nState, action);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function secondValueInput(state, number) {
	  if (_underscore2.default.isUndefined(state.snd_value)) {
	    return {
	      last_input: number,
	...
	function numberReducer(state, action) {
	  ...
	  if (_underscore2.default.isNaN(number)) {
	    return state;
	  }

	  if ((0, _util.isOperator)(state.last_input) || !_underscore2.default.isUndefined(state.snd_value)) {
...
/***/ function(module, exports) {
	...
	var execute = exports.execute = function execute(op, one, two) {
	  switch (op) {
	    case '+':
	      return one + two;
	    case '-':
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = operatorReducer;

	var _underscore = __webpack_require__(169);

	var _underscore2 = _interopRequireDefault(_underscore);

	var _mainOpReducer = __webpack_require__(173);

	var _mainOpReducer2 = _interopRequireDefault(_mainOpReducer);

	var _equalOpReducer = __webpack_require__(174);

	var _equalOpReducer2 = _interopRequireDefault(_equalOpReducer);
	...
	function operatorReducer(state, action) {
	  var operator = action.value;
	  switch (operator) {
	    case '-':
	      return (0, _mainOpReducer2.default)(state, operator);
	    case '+':
	      return (0, _mainOpReducer2.default)(state, operator);
	    case '*':
	      return (0, _mainOpReducer2.default)(state, operator);
	    case '=':
	      return (0, _equalOpReducer2.default)(state);
	    case '+/-':
	      return plusMinusReducer(state, operator);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function sumValues(state, operator) {
	  if (_underscore2.default.isNumber(state.memory) && _underscore2.default.isNumber(state.snd_value)) {
	    return {
	      last_input: operator,
	      last_op: operator,
	      memory: (0, _util.execute)(state.last_op, state.memory, state.snd_value),
	      snd_value: undefined,
	      screen: (0, _util.execute)(state.last_op, state.memory, state.snd_value)
	    };
	  }
	...
	function operatorReducer(state) {
	  var operator = arguments.length <= 1 || arguments[1] === undefined ? PLUS : arguments[1];

	  if (_underscore2.default.isUndefined(state.memory)) {
	...
	function operatorReducer(state) {
	  if (state.last_input === EQUAL) {
	    return {
	      last_input: EQUAL,
	      last_op: state.last_op,
	      memory: (0, _util.execute)(state.last_op, state.screen, state.snd_value),
	      snd_value: state.snd_value,
	      screen: (0, _util.execute)(state.last_op, state.screen, state.snd_value)
	    };
	  }

	  if (!_underscore2.default.isUndefined(state.last_op)) {
	    var nState = {
	      last_input: EQUAL,
	      last_op: state.last_op,
	      memory: (0, _util.execute)(state.last_op, state.memory, state.screen),
	      snd_value: state.snd_value,
	      screen: (0, _util.execute)(state.last_op, state.memory, state.screen)
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _calcButton = __webpack_require__(189);

	var _screen = __webpack_require__(190);

	var _screen2 = _interopRequireDefault(_screen);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var ButtonRow = function ButtonRow(props) {
	  return _react2.default.createElement(
	    'div',
	    { className: 'calc_btn-row' },
	    props.children
	  );
	};
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ButtonRow,
	        null,
	        _react2.default.createElement(_calcButton.ACButton, this.props),
	        _react2.default.createElement(
	          _calcButton.CalcButton,
	          this.props,
	          '+/-'
	        ),
	        _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          _calcButton.CalcButton,
	          _extends({}, this.props, { className: 'zero' }),
	          '0'
	        ),
	        _react2.default.createElement(
	          _calcButton.CalcButton,
	...
	exports.default = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(_screen2.default, { value: store.getState().screen }),
	      _react2.default.createElement(ButtonContainer, { clearScreen: this.clearScreen,
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.OperatorBtn = exports.ACButton = exports.CalcButton = undefined;
	...
	var CalcButton = exports.CalcButton = _react2.default.createClass({
	  displayName: 'CalcButton',
	...
	var ACButton = exports.ACButton = _react2.default.createClass({
	  displayName: 'ACButton',
	...
	var OperatorBtn = exports.OperatorBtn = _react2.default.createClass({
	  displayName: 'OperatorBtn',
	  render: function render() {
	    return _react2.default.createElement(
	      CalcButton,
	      _extends({}, this.props, { className: 'operator' }),
	      this.props.children
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _artist = __webpack_require__(196);

	var _artist2 = _interopRequireDefault(_artist);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var TestUtils = __webpack_require__(197);

	describe('Artist', function () {
	  var component;

	  beforeEach(function () {
	    component = TestUtils.renderIntoDocument(_react2.default.createElement(_artist2.default, { name: 'Run the jewels' }));
	  });

	  it("should display the artist name", function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAddonsTestUtils = __webpack_require__(197);
	...
	describe('Screen', function () {
	  ...
	  beforeEach(function () {
	    component = _reactAddonsTestUtils2.default.renderIntoDocument(_react2.default.createElement(_screen2.default, { value: '0' }));
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	describe('CalcButton', function () {
	  ...
	  beforeEach(function () {
	    component = TestUtils.renderIntoDocument(_react2.default.createElement(
	      _calcButton.CalcButton,
	      null,
	      'Hello'
	    ));
	    node = _reactDom2.default.findDOMNode(component);
	  });

	  describe("by default", function () {
	    it("should display text as button content", function () {
	      expect(node.textContent).toMatch(/Hello/);
	    });

	    it("should have calc-btn class attribute by default", function () {
	      expect(node.className).toMatch(/calc-btn/);
	    });
	  });

	  it('should allow custom classnames to be added', function () {
	    component = TestUtils.renderIntoDocument(_react2.default.createElement(
	      _calcButton.CalcButton,
	      { className: 'myButton' },
	      'Hello'
	  ...
	  describe("when clicked", function () {
	    it('should make a call to update the screen', function () {
	      var props = { updateScreen: function updateScreen() {} };
	...
	describe("ACButton", function () {
	  it("should display a button with AC as it's content", function () {
	    var component = TestUtils.renderIntoDocument(_react2.default.createElement(_calcButton.ACButton, null));
	    var node = _reactDom2.default.findDOMNode(component);
	    expect(node.textContent).toMatch(/AC/);
	  });

	  it('should invoke clearScreen when clicked', function () {
	    var props = { clearScreen: function clearScreen() {} };
	    spyOn(props, 'clearScreen');

	    var component = TestUtils.renderIntoDocument(_react2.default.createElement(_calcButton.ACButton, props));
	    var node = _reactDom2.default.findDOMNode(component);
	    TestUtils.Simulate.click(node);
	...
	describe("OperatorButton", function () {
	  var component = void 0;
	  var node = void 0;
	  ...
	  it("should display a button with Operation as it's content", function () {
	    expect(node.textContent).toMatch(/\+/);
	  });

	  it('should have a custom classname operator', function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _calculator = __webpack_require__(188);
	...
	var _calculatorReducer = __webpack_require__(168);
	...
	describe('Calculator', function () {
	  var component = void 0;
	  var calcStore = void 0;

	  beforeEach(function () {
	    calcStore = (0, _redux.createStore)(_calculatorReducer.reducer);
	  });

	  it("should display the 0 zero by default", function () {
	    component = _reactAddonsTestUtils2.default.renderIntoDocument(_react2.default.createElement(_calculator2.default, { store: calcStore }));
	    var arr = _reactAddonsTestUtils2.default.findAllInRenderedTree(component, function (com) {
	      return _reactAddonsTestUtils2.default.isCompositeComponentWithType(com, _screen2.default);
	    });

	    var node = _reactDom2.default.findDOMNode(arr[0]);
	    expect(node.textContent).toEqual('0');
	  });

	  describe("when number is clicked", function () {
	  ...
	  describe("when plus operator is clicked", function () {
	    beforeEach(function () {
	      spyOn(calcStore, 'dispatch').and.callThrough();
	      component = _reactAddonsTestUtils2.default.renderIntoDocument(_react2.default.createElement(_calculator2.default, { store: calcStore }));
	    });
	    ...
	    describe("when number is entered first", function () {
	    ...
	    describe("when number is entered twice", function () {
	      it('should display the sum of the two numbers', function () {
	        whenNumberButtonIsClicked(component, '4');
	        whenOperatorIsClicked(component, '+');
	  ...
	  describe("when minus operator is clicked", function () {
	    beforeEach(function () {
	      spyOn(calcStore, 'dispatch').and.callThrough();
	      component = _reactAddonsTestUtils2.default.renderIntoDocument(_react2.default.createElement(_calculator2.default, { store: calcStore }));
	    });
	  ...
	  describe("when multiply operator is clicked", function () {
	    beforeEach(function () {
	      spyOn(calcStore, 'dispatch').and.callThrough();
	      component = _reactAddonsTestUtils2.default.renderIntoDocument(_react2.default.createElement(_calculator2.default, { store: calcStore }));
	    });
	  ...
	  describe("when equal operator is clicked", function () {
	    ...
	    describe("when number is entered first", function () {
	      ...
	      describe("then non equal operator is clicked", function () {
	      ...
	      describe("then non equal operator and equal operator are clicked", function () {
	        it('should increase the value by the original screen value', function () {
	          whenNumberButtonIsClicked(component, '4');
	          whenOperatorIsClicked(component, '+');
	          whenOperatorIsClicked(component, '=');
	          whenOperatorIsClicked(component, '=');
	  ...
	  describe("mix of plus and equal operator", function () {
	  ...
	  describe('when AC it clicked', function () {
	    it('should reset value of screen', function () {
	      spyOn(calcStore, 'dispatch').and.callThrough();
	  ...
	  describe("when +/- button is clicked", function () {
	    it('should invert the sign of the value', function () {
	      spyOn(calcStore, 'dispatch').and.callThrough();
	      component = _reactAddonsTestUtils2.default.renderIntoDocument(_react2.default.createElement(_calculator2.default, { store: calcStore }));
	      whenNumberButtonIsClicked(component, '3');
	    ...
	    describe("when +/- button is clicked for 2nd time", function () {
	      it('should invert the sign back to original value', function () {
	        spyOn(calcStore, 'dispatch').and.callThrough();
	        component = _reactAddonsTestUtils2.default.renderIntoDocument(_react2.default.createElement(_calculator2.default, { store: calcStore }));
	        whenNumberButtonIsClicked(component, '3');
	        whenNumberButtonIsClicked(component, '+/-');
	    ...
	    describe("When the following sequence is inputted", function () {
	      it('should result in zero', function () {
	        spyOn(calcStore, 'dispatch').and.callThrough();
	        component = _reactAddonsTestUtils2.default.renderIntoDocument(_react2.default.createElement(_calculator2.default, { store: calcStore }));
	        whenNumberButtonIsClicked(component, '3');
	        whenOperatorIsClicked(component, '+');
	  ...
	  function thenScreenUpdatesTo(value) {
	    var component = _reactAddonsTestUtils2.default.renderIntoDocument(_react2.default.createElement(_calculator2.default, { store: calcStore }));
	    var scrnNode = _reactDom2.default.findDOMNode(getScreen(component));
	  ...
	  function whenOperatorIsClicked(component, operator) {
	    var operatorBtns = getComponent(component, _calcButton.OperatorBtn);
	    var operatorBtn = operatorBtns.find(function (btn) {
	      return btn.props.children === operator;
	    });
	    var btnNode = _reactDom2.default.findDOMNode(operatorBtn);
	    expect(btnNode.textContent).toEqual(operator);
	    _reactAddonsTestUtils2.default.Simulate.click(btnNode);
	  }

	  function whenNumberButtonIsClicked(component, number) {
	    var numberButtons = getComponent(component, _calcButton.CalcButton);
	    var numberButton = numberButtons.find(function (btn) {
	      return btn.props.children === number;
	    });
	    var buttonNode = _reactDom2.default.findDOMNode(numberButton);
	    expect(buttonNode.textContent).toEqual(number);
	    _reactAddonsTestUtils2.default.Simulate.click(buttonNode);
	  }
	  ...
	  function whenACButtonIsClicked(component) {
	    var buttons = getComponent(component, _calcButton.ACButton);
	    var acButtonNode = _reactDom2.default.findDOMNode(buttons[0]);
	    expect(acButtonNode.textContent).toEqual('AC');
	    _reactAddonsTestUtils2.default.Simulate.click(acButtonNode);
	  }

	  function getScreen(component) {
	    return getComponent(component, _screen2.default)[0];
	  }

	  function getComponent(root, componentType) {
	    return _reactAddonsTestUtils2.default.findAllInRenderedTree(root, function (com) {
	      return _reactAddonsTestUtils2.default.isCompositeComponentWithType(com, componentType);
	    });
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	describe("CalculatorReducer", function () {
	  ...
	  describe("by default", function () {
	    it('should have a state of initial values', function () {
	      expect((0, _calculatorReducer.reducer)(undefined, {})).toEqual(getInit());
	    });
	  });

	  describe("when state is the init state", function () {
	    describe("when user inputs a number", function () {
	      it('should set the number to the passed value', function () {
	        var result = (0, _calculatorReducer.reducer)(getInit(), { type: 'UPDATE_VALUE', value: '4' });
	    ...
	    describe("when user hits +/- button", function () {
	      it('should have no effect', function () {
	        var result = (0, _calculatorReducer.reducer)(getInit(), { type: 'UPDATE_VALUE', value: '+/-' });
	  ...
	  describe("when screen value is not zero", function () {
	    it('should append the passed value to the number', function () {
	      var state = getInit();
	      state.screen = 4;
	      state.last_input = 4;

	      expect((0, _calculatorReducer.reducer)(state, { type: 'UPDATE_VALUE', value: '8' })).toEqual({
	        last_input: 8,
	        last_op: undefined,
	        memory: undefined,
	        snd_value: undefined,
	    ...
	    describe("when user hits +/- button", function () {
	      it('should inverse the sign of the value', function () {
	        var result = (0, _calculatorReducer.reducer)(getInit(), { type: 'UPDATE_VALUE', value: '4' });
	        result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '+/-' });
	      ...
	      describe("when user hits +/- again", function () {
	        it('should inverse the sign of the value back again', function () {
	          var result = (0, _calculatorReducer.reducer)(getInit(), { type: 'UPDATE_VALUE', value: '4' });
	          result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '+/-' });
	          result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '+/-' });
	  ...
	  describe("when the value is not a number or an operator", function () {
	    it('should return state', function () {
	      var result = (0, _calculatorReducer.reducer)(getInit(), { type: 'UPDATE_VALUE', value: 'ASD' });
	      expect(result).toEqual(getInit());
	    });
	  });

	  describe('when a user clears the value', function () {
	    it('should reset the value to initial state', function () {
	      var state = getInit();
	      state.screen = 4;
	      state.last_input = 4;

	      var result = (0, _calculatorReducer.reducer)(state, { type: 'CLEAR_VALUE' });
	      expect(result).toEqual(getInit());
	    });
	  });
	  ...
	  describe("mix of plus and equal operator", function () {
	    it('should display correct output', function () {
	      var result = (0, _calculatorReducer.reducer)(getInit(), { type: 'UPDATE_VALUE', value: '3' });
	      result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '+' });
	      result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '3' });
	      result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '=' });
	      result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '+' });
	      result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '5' });
	      result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '=' });
...
/***/ function(module, exports, __webpack_require__) {
	...
	describe("PlusOperator", function () {

	  describe("when state is the init state", function () {
	    describe("when user inputs a plus operator", function () {
	      it("should set zero as the memory value and update the screen", function () {
	        var state = getInit();

	        var result = (0, _calculatorReducer.reducer)(state, { type: 'UPDATE_VALUE', value: '+' });
	  ...
	  describe("when user has input a value", function () {
	    describe("when user inputs a plus operator", function () {
	      it('should set memory as the screen value and update the screen', function () {
	        var state = getInit();

	        var result = (0, _calculatorReducer.reducer)(state, { type: 'UPDATE_VALUE', value: '1' });
	        result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '+' });
	  ...
	  describe("when user has already input a plus operator", function () {
	    describe("when user inputs a plus operator again", function () {
	      it('should keep the same state', function () {
	        var state = getInit();
	    ...
	    describe("when user inputs a number value", function () {
	      it('should add the value to snd_value and update the screen', function () {
	        var state = getInit();
	      ...
	      describe("when value exists for snd_value", function () {
	        it('should append the value to snd_value and update the screen', function () {
	          var state = getInit();

	          var result = (0, _calculatorReducer.reducer)(state, { type: 'UPDATE_VALUE', value: '1' });
	          result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '+' });
	          result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '2' });
	          result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '3' });
	  ...
	  describe("when user inputs a plus operator", function () {
	    describe("when 2nd value and memory are populated", function () {
	      it('should add the value into memory, reset the 2nd value and update screen', function () {
	        var state = getInit();
...
/***/ function(module, exports, __webpack_require__) {
	...
	describe("MinusOperator", function () {

	  describe("when state is the init state", function () {
	    describe("when user inputs a minus operator", function () {
	      it("should set zero as the memory value and update the screen", function () {
	        var state = getInit();
	  ...
	  describe("when user has already input a minus operator", function () {
	    describe("when user inputs a plus operator", function () {
	      it('should override the last op', function () {
	        var state = getInit();
	    ...
	    describe("when user inputs a minus operator again", function () {
	      it('should keep the same state', function () {
	        var state = getInit();
	    ...
	    describe("when user inputs a number value", function () {
	      it('should subtract the value to snd_value and update the screen', function () {
	        var state = getInit();
	  ...
	  describe("when user inputs a minus operator", function () {
	    describe("when 2nd value and memory are populated", function () {
	      it('should subtract the value into memory, reset the 2nd value and update screen', function () {
	        var state = getInit();
	  ...
	  describe("mixing minus and plus", function () {
	    it('produce the correct result', function () {
	      var state = getInit();

	      var result = (0, _calculatorReducer.reducer)(state, { type: 'UPDATE_VALUE', value: '2' });
	      result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '+' });
	      result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '6' });
	      result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '-' });
	      result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '3' });
	      result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '=' });
...
/***/ function(module, exports, __webpack_require__) {
	...
	describe("EqualOperator", function () {
	  ...
	  describe("when state is the init state", function () {
	    describe("when user inputs a equal operator", function () {
	      it("should set zero as the memory value", function () {
	        var result = (0, _calculatorReducer.reducer)(getInit(), { type: 'UPDATE_VALUE', value: '=' });
	  ...
	  describe("when user has input a value", function () {
	    describe("when user inputs a equal operator", function () {
	      it('should set memory as the screen value and update the screen', function () {
	        var result = (0, _calculatorReducer.reducer)(getInit(), { type: 'UPDATE_VALUE', value: '1' });
	        result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '=' });
	    ...
	    describe("when user inputs a non equal operator", function () {
	      describe("when user then inputs an equal operator", function () {
	        it('should set screen value to snd_value, sum the value and update the memory and screen', function () {
	          var result = (0, _calculatorReducer.reducer)(getInit(), { type: 'UPDATE_VALUE', value: '1' });
	          result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '+' });
	          result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '=' });
	        ...
	        describe("when user inputs an equal operator again", function () {
	          it('should perform the last operation', function () {
	            var result = (0, _calculatorReducer.reducer)(getInit(), { type: 'UPDATE_VALUE', value: '1' });
	            result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '+' });
	            result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '=' });
	            result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '=' });
...
/***/ function(module, exports, __webpack_require__) {
	...
	describe("MultiplyOperator", function () {

	  describe("when state is the init state", function () {
	    describe("when user inputs a multiply operator", function () {
	      it("should set zero as the memory value and update the screen", function () {
	        var state = getInit();
	  ...
	  describe("when user has already input a multiply operator", function () {
	    describe("when user inputs a multiply operator again", function () {
	      it('should keep the same state', function () {
	        var state = getInit();
	    ...
	    describe("when user inputs a number value", function () {
	      it('should multiply the value to snd_value and update the screen', function () {
	        var state = getInit();
	  ...
	  describe("when user inputs a multiply operator", function () {
	    describe("when 2nd value and memory are populated", function () {
	      it('should add the value into memory, reset the 2nd value and update screen', function () {
	        ...
	        var result = (0, _calculatorReducer.reducer)(state, { type: 'UPDATE_VALUE', value: '4' });
	        result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '*' });
	        result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '2' });
	        result = (0, _calculatorReducer.reducer)(result, { type: 'UPDATE_VALUE', value: '*' });
